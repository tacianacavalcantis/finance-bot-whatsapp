...
async initialize() {
    ...
    async sendStartupMessage() {
        // Enviar mensagem de boas-vindas para todos os membros
    ...
    async handleMessage(message) {
        ...
        const memberName = this.getMemberName(from, notifyName);
            ...
            // Ignorar mensagens de grupos (se quiser, pode habilitar)
            ...
            // Se não for comando, tentar parser como transação
